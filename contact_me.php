<?php
$recipient_email    = "laurasan207@gmail.com"; //recepient
$from_email         = "laurrasann@gmail.com"; //from email using site domain.
...
if($_POST){
    ...
    $attachments = filter_var($_FILES)['file_attach'];
    ...
    {
        print json_encode(array('Thank you for your submission and for contacting us, we have received your message!'));
		exit;
    }else{
